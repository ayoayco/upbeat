...
?>
	...
	?>
		<div id="home-sidebar" style="width: 250px; float: left;">
			<a href="./shop"><?php echo '<img width="250px" src="' . $woocommerce->plugin_url() . '/assets/images/splices/buy_online.jpg" alt="Buy Online" />';?></a>
			<a href="./howtobuy"><?php echo '<img width="250px" src="' . $woocommerce->plugin_url() . '/assets/images/splices/how_to_buy.jpg" alt="How to Buy" />';?></a>
		</div>
		...
		<div style="border-top: solid 15px #8c1010; margin-top:5px;" id="featured-products" class="<?php if ( get_option( 'woo_featured_product_style' ) == 'slider' ) { echo 'fp-slider'; } ?>">
			...
			<!--a id="contact-us-square" href="./store-locations-2">
				<?php echo '<img width="250px" src="' . $woocommerce->plugin_url() . '/assets/images/splices/contact-us-square.jpg" alt="How to Buy" />';?>
			</a-->
