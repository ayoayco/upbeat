	    ...
	    <div class="header" style=" background: transparent;">
			...
			<!-- nav menu -->
				<div id="navigation" class="col-full" style="background: transparent; border:0px; width: 350px; margin: 0px; margin-left: 220px; margin-top: 30px; padding-top: 20px;" class="float-left">
			        ...
			        <?php }
						if($woocommerce->cart->cart_contents_count > 0) echo '<span style="float: right; margin-top: 0px; margin-right: 30px;" id="cartcount">'.sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'woothemes'), $woocommerce->cart->cart_contents_count).'</span>';
			        ?>
...
<div id="metacontainer" style="margin:0; width:720px; max-height: 500px; float:left; margin-right: 10px;">
	<div id="metaslider">
	<?php 
